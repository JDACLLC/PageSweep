...
9. The service worker starts the download using a sanitized timestamped filename, displays the check at the lower-right above the progress track, and holds the completed state for 1.7 seconds while the mascot hovers in the upper-right.
