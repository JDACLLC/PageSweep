...
- Visually verify the white/purple/dark toolbar-eye cycle in PageSweep 0.2.17; check toolbar animation summary if eyes remain static and fainter unfinished track.
